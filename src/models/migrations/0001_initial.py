# Generated by Django 3.2.4 on 2022-08-23 00:07
    ...
    operations = [
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ('not_available', 'The default status for newly created inspection which is still pending.'),
                        ],
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        default=Decimal('0'),
                        help_text='min price at which the car can be sold, given the expenses we already made. this should be determined by calculating how much maintanance is done + total disbursement at the end of trade',
                        max_digits=10,
                        validators=[django.core.validators.MinValueValidator(Decimal('0'))],
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'transmission',
                    models.CharField(
                        choices=[('manual', 'Manual'), ('automatic', 'Automatic'), ('standard', 'Who knows')], max_length=15
                    ),
                ),
                (
                    'car_type',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'expiry',
                    models.DateTimeField(default=datetime.datetime(2022, 8, 23, 0, 37, 47, 802897, tzinfo=utc), editable=False),
                ),
                (
                    'status',
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='New notification', max_length=50)),
