    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(
                    choices=[('failed_inspection', 'Failed Inspection'), ('inspected', 'inspected'),
                             ('available', 'available'), ('bought', 'bought'), ('sold', 'sold')], max_length=30)),
                ...
                ('cost', models.DecimalField(decimal_places=10, editable=False, help_text='cost of  purchasing the car',
                                             max_digits=10, max_length=10)),
                ('cost_of_repairs',
                 models.DecimalField(decimal_places=10, editable=False, help_text='Total cost of spare parts',
                                     max_digits=10, max_length=10)),
                ('total_cost', models.DecimalField(decimal_places=10, editable=False,
                                                   help_text='Total cost = cost + cost_of_repairs + maintainance_cost + misc',
                                                   max_digits=10, max_length=10)),
                ('maintainance_cost', models.DecimalField(decimal_places=10, editable=False,
                                                          help_text='fuel, parking, mechanic workmanship costs',
                                                          max_digits=10, max_length=10)),
                ('resale_price',
                 models.DecimalField(blank=True, decimal_places=10, help_text='price presented to merchants',
                ...
                ('margin', models.DecimalField(decimal_places=10, editable=False,
                                               help_text='The profit that was made from car after sales in percentage of the total cost',
                                               max_digits=10, max_length=10)),
                ('car_type', models.CharField(choices=[('suv', 'suv'), ('saloon', 'saloon'), ('minivan', 'minivan'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='merchant',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('return_on_trade',
                 models.DecimalField(decimal_places=10, default=Decimal('0'), max_digits=10, max_length=10,
                                     validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('estimated_return_on_trade',
                 models.DecimalField(decimal_places=10, default=Decimal('0'), max_digits=10, max_length=10,
                                     validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('remaining_slots',
                 models.PositiveIntegerField(default=0, help_text='slots that are still available for sale')),
                ('price_per_slot', models.DecimalField(decimal_places=10, default=Decimal('0'), editable=False,
                                                       help_text='price per slot', max_digits=10, max_length=10,
                                                       validators=[
                ...
                ('trade_status', models.CharField(
                    choices=[('pending', 'Pending review'), ('ongoing', 'Slots are yet to be fully bought'),
                             ...
                             ('purchased', 'All slots have been bought by merchants')], max_length=20)),
                ('min_sale_price', models.DecimalField(decimal_places=10, default=Decimal('0'),
                                                       help_text='min price at which the car can be sold',
                                                       max_digits=10, max_length=10, validators=[
                        django.core.validators.MinValueValidator(Decimal('0'))])),
                ('max_sale_price', models.DecimalField(decimal_places=10, default=Decimal('0'),
                ...
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trades',
                                          to='models.car')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('merchant', models.OneToOneField(help_text='merchant user wallet that holds monetary balances',
                                                  on_delete=django.db.models.deletion.CASCADE, related_name='wallet',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('expired', 'User already deleted device from device management'),
                                                     ('active', 'Transaction pin is still active'),
                                                     ('deleted', 'Transaction pin has been deleted')], max_length=10)),
                ('pin', models.CharField(max_length=200)),
                ('device_name', models.CharField(help_text='The name of the device i.e Iphone x', max_length=50)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transaction_pins',
                                           to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_status',
                 models.CharField(choices=[('success', 'Success'), ('failed', 'Failed'), ('pending', 'Pending')],
                ...
                ('transaction_kind', models.CharField(
                    choices=[('deposit', 'Deposit'), ('withdrawal', 'Withdrawal'), ('transfer', 'Transfer'),
                             ('wallet_transfer', 'Wallet Transfer')], default='deposit', max_length=50)),
                ('transaction_payment_link', models.URLField(blank=True, null=True)),
                ('wallet', models.ForeignKey(help_text='transactions carried out by merchant',
                                             on_delete=django.db.models.deletion.CASCADE,
                                             related_name='merchant_transactions', to='models.wallet')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id',
                 model_utils.fields.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('share_percentage', models.DecimalField(decimal_places=10, default=Decimal('0'), editable=False,
                                                         help_text='the percentage of this unit in the trade',
                                                         max_digits=10, max_length=10)),
                ('slots_quantity', models.PositiveIntegerField(default=1)),
                ('unit_value', models.DecimalField(decimal_places=10, default=Decimal('0'), editable=False,
                                                   help_text='The amount to be paid given the slots quantity x trade.price_per_slot',
                                                   max_digits=10, max_length=10)),
                ('vat_percentage',
                 models.DecimalField(blank=True, decimal_places=10, default=Decimal('0'), editable=False,
                                     help_text='the percentage of vat to be paid. calculated in relation to share percentage of tradeUnit in trade',
                                     max_digits=10, max_length=10, null=True)),
                ('estimated_rot', models.DecimalField(decimal_places=10, default=Decimal('0'), editable=False,
                                                      help_text='the estimated return on trade', max_digits=10,
                                                      max_length=10, validators=[
                        django.core.validators.MinValueValidator(Decimal('0'))])),
                ('merchant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='units',
                                               to='models.carmerchant')),
                ('trade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='units',
                                            to='models.trade')),
                ('transaction', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT,
                                                  related_name='trade_units', to='models.transaction')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiry', models.DateTimeField(default=datetime.datetime(2022, 4, 11, 16, 33, 8, 703584, tzinfo=utc),
                                                editable=False)),
                ('status', models.CharField(choices=[('verified', 'Otp verified by user successfully'),
                                                     ('failed', 'User entered wrong otp until disabled'),
                                                     ('expired', 'Otp was not entered before it expired'), ('pending',
                                                                                                            'Otp is yet to expire or has expired and no one sent a verification request for it')],
                                            default='pending',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade_unit',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trade_units',
                                   to='models.tradeunit')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id',
                 model_utils.fields.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('type', models.CharField(choices=[('spare_part', 'Car spare parts i.e brake.'), (
                'expense', 'other expenses made on the car that doesnt directly relate to a physical parts.')],
                                          max_length=20)),
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='maintanances',
                                          to='models.car')),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL,
                                       to=settings.AUTH_USER_MODEL, validators=[src.models.models.validate_inspector]),
        ),
        migrations.CreateModel(
            name='BankAccount',
            fields=[
                ...
                ('merchant', models.ForeignKey(help_text='Bank account to remit merchant money to',
                                               on_delete=django.db.models.deletion.CASCADE,
                                               related_name='bank_accounts', to='models.carmerchant')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_type', models.CharField(
                    choices=[('transaction', 'transaction'), ('trade_unit', 'trade_unit'),
                             ('disbursement', 'disbursement')], max_length=15)),
