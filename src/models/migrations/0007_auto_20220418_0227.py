    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[('suv', 'suv'), ('saloon', 'saloon'), ('minivan', 'minivan'), ('convertible', 'convertible'),
                         ('microcar', 'microcar'), ('city_car', 'City car'), ('hatchback', 'Hatchback'),
                         ('sedan', 'sedan'), ('family_car', 'Family car'), ('muscle_car', 'Muscle car'),
                         ('roadstar', 'Roadstar'), ('pickup', 'pickup'), ('coupe', 'coupe')], default='expense',
                max_length=30),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('failed_inspection', 'Failed Inspection'), ('inspected', 'inspected'),
                                            ('available', 'available for trading and sale'), ('bought', 'bought'),
        ...
        migrations.AlterField(
            model_name='otp',
            name='expiry',
            field=models.DateTimeField(default=datetime.datetime(2022, 4, 18, 2, 57, 0, 652971, tzinfo=utc),
                                       editable=False),
        ),
        ...
        migrations.AddField(
            ...
            name='car',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='maintenances',
                                    to='models.car'),
        ),
        migrations.AddField(
            model_name='carmaintenance',
